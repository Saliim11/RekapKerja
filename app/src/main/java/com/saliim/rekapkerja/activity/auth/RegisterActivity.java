...
import com.saliim.rekapkerja.model.register.ResponseRegister;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    TextView txtToLogin;
    @BindView(R.id.spinKelas)
    Spinner spinKelas;
    @BindView(R.id.spinBagian)
    Spinner spinBagian;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btnRegister:
                ...
                String leveluser = "";
//                kelasUser = spinKelas.getSelectedItem().toString();
