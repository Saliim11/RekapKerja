...
public class ResponseListKerjaanStaff {
	...
	@Override
 	public String toString(){
		return 
			"ResponseListKerjaanStaff{" +
			"poin_kerjaan = '" + poinKerjaan + '\'' + 
			",waktu_kerjaan = '" + waktuKerjaan + '\'' + 
			",nama_kerjaan = '" + namaKerjaan + '\'' + 
			",hari_kerjaan = '" + hariKerjaan + '\'' + 
			",level_kerjaan = '" + levelKerjaan + '\'' + 
			",id_kerjaan = '" + idKerjaan + '\'' + 
			"}";
		}
}